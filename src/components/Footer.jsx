            ...
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div>
                            <p className="text-emerald-200 mb-1 text-sm">Participation Inquiries:</p>
                            <p className="text-emerald-200 text-sm">Muhammad Umair Ali</p>
                        </div>

                        <div>
                            <p className="text-emerald-200 mb-1 text-sm">Program and Fellowship</p>
                            <p className="text-emerald-200 text-sm">Uzair Farooqi</p>
                            <p className="text-emerald-200 text-sm">uzaifarooqi@gmail.com</p>
                        </div>
                ...
                <div>
                    ...
                    <div className="flex items-start space-x-2">
                        ...
                        <div>
                            <p className="text-emerald-200 text-sm">Date: 17th and 18th November 2025</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="space-y-2">
                        <Link to={'schedule'} className="block text-emerald-200 hover:text-white transition-colors text-sm">
                            Program Schedule
                        </Link>
                        <Link to={'#'} className="block text-emerald-200 hover:text-white transition-colors text-sm">
                ...
                <div>
                    ...
                    <div className="space-y-3">
                        <div className="flex items-start space-x-2">
                            ...
                            <div>
                                <p className="text-emerald-200 font-medium text-sm">University of Engineering & Technology</p>
                                <p className="text-emerald-200 text-xs">UET Lahore, Punjab, Pakistan</p>
                            </div>
                        </div>

...
const Footer = () => {
  return (
    <footer className="bg-[#207140] text-white py-8 mt-8">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              >
                <p className="text-white/80 text-sm hover:text-[#95c065] transition-colors duration-300">umair@gmail.com</p>
              </a>
            </div>
            ...
            <div>
              ...
              <a
                ...
                className="hover:text-[#95c065] transition-colors duration-300"
              >
                <p className="text-white/80 text-sm hover:text-[#95c065] transition-colors duration-300">naval@gmail.com</p>
              </a>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex items-start space-x-2">
            <Calendar className="w-4 h-4 text-[#95c065] mt-1 flex-shrink-0" />
            <div>
        ...
        <div>
          ...
          <div className="space-y-3">
            <div className="flex items-start space-x-2">
              <MapPin className="w-4 h-4 text-[#95c065] mt-1 flex-shrink-0" />
              <div>
            ...
            {/* Embedded Map */}
            <div>
              <div className="w-full h-32 bg-[#95c065]/20 rounded-lg overflow-hidden border border-[#95c065]/30">
                <iframe
      ...
      {/* Follow Us Section */}
      <div className="max-w-7xl mx-auto px-4 mt-8 pt-6 border-t border-[#95c065]/30">
        <h3 className="text-lg font-bold mb-3">Follow Us</h3>
        <div className="flex space-x-3">
          <a
            href="https://www.linkedin.com/company/apigapakistan/"
            className="w-9 h-9 bg-[#95c065] rounded-lg flex items-center justify-center hover:bg-white hover:text-[#207140] transition-all duration-300"
            aria-label="LinkedIn"
            target="_blank"
          >
          ...
          <a
            ...
            className="w-9 h-9 bg-[#95c065]/80 rounded-lg flex items-center justify-center hover:bg-white hover:text-[#207140] transition-all duration-300"
